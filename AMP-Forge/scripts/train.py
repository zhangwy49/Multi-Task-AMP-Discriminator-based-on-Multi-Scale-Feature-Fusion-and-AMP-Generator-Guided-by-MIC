...
def parse_args():
    ...
    parser.add_argument("--csv_file", type=str, default='../preprocessed_data/AMP/amp.csv', help="Path to CSV data.")
    ...
    parser.add_argument("--prefix", type=str, default="template", help="Prefix of checkpoints.")
...
def train(args):
    ...
    ckpt_filename = f"{args.prefix}-expkl={args.expected_kl}-vae-{data_name}_" \
        + "{epoch:02d}-{train_loss:.3f}-{valid_loss:.3f}-GRULatentEncoder"
